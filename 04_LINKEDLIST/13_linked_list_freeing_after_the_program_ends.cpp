/*
Deleting All The Linked List Elements After The Program Ends
*/
#include<iostream>
using namespace std;
class Nodes{
...
//Deleting All The Linked List After The Program Ends
class LinkedList{
    public:
        Nodes *header;
        Nodes *tail;
    LinkedList(Nodes *header,Nodes *tail){
        this->header=header;
        this->tail=header;
    }
    ~LinkedList(){
        while(tail!=NULL){
            ...
            delete header;
            header=tail;
            //cout<<"Deleted"<<endl; (Checking Whether Deletion Is Working Or Not)
        }
    }
